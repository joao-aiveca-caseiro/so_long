...
/*   Updated: 2023/03/17 07:06:27 by jaiveca-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	animate_enemies(t_win window, int sprite_nb)
{
	...
	while (window.map[++y])
	{
		...
		{
			animate_enemies_frames_1to12(window, sprite_nb, x, y);
			animate_enemies_frames_13to23(window, sprite_nb, x, y);
		}
		x = -1;
	}
}

void	animate_enemies_frames_1to12(t_win window, int sprite_nb, int x, int y)
{
...
void	animate_enemies_frames_13to23(t_win window, int sprite_nb, int x, int y)
{
	if (window.map[y][x] == 'N' && sprite_nb == 13)
